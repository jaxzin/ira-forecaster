 ...
 */
public class SGSSimulateInterestDuringBothPhasesTest extends AbstractSGSSimulateTest {
    ...
    protected CaseData getCaseData() {
        ...
        cd.sim.getDomain().setRetirementAge(35);
        ...
        cd.sim.getDomain().setRor1(Quantity.<Dimensionless>valueOf("10 %"));
        cd.sim.getDomain().setRor2(Quantity.<Dimensionless>valueOf("5 %"));
        ...
        cd.expected.add(Quantity.<Money>valueOf("1.6910355 USD"));
        cd.expected.add(Quantity.<Money>valueOf("1.775587275 USD"));
        cd.expected.add(Quantity.<Money>valueOf("1.86436663875 USD"));
        cd.expected.add(Quantity.<Money>valueOf("1.9575849706875013 USD"));
        cd.expected.add(Quantity.<Money>valueOf("2.0554642192218764 USD"));
